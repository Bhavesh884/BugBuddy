    ...
    try {
      ...
      const res = await axios.patch(
        BASE_URL + "/profile/edit",
        {
          ...
          gender: userFormData?.gender === "" ? "male" : userFormData?.gender,
      ...
      >
        <div className="bg-[#0f0f0f] text-white flex flex-col md:flex-row font-sans">
          ...
          <div className="md:w-2/3 w-full p-6 md:p-12 ">
            ...
            <button
              className="btn bg-[#36746e] hover:bg-[#24474c] transition-all"
